...
| Selenium.WebDriver | 3.141.0 | 4.44.0 | 1 major | **Critical** | All 5 projects (transitive) |
| Selenium.Support | 3.141.0 | 4.44.0 | 1 major | **Critical** | Api, Api.UCI, Browser |
| System.Drawing.Common | 6.0.0 | 10.0.8 | 4 major | High | Browser |
...
| Otp.NET | 1.2.1/1.4.0 | 1.4.1 | Patch | OTP generation fixes |
...
|---------|---------|--------|--------|
| Newtonsoft.Json | 13.0.1 | 13.0.4 | Bug fixes |
...
**3. GHSA-7jgj-8wvc-jh57 - System.Net.Http 4.3.0**
- **Severity:** High
- **Package:** System.Net.Http 4.3.0 (transitive)
- **Impact:** HTTP/2 Rapid Reset vulnerability (CVE-2023-44487) - Denial of Service attack vector
- **Affected Projects:** All 5 projects (transitive dependency)
...
- **Impact:** TLS/SSL security vulnerabilities allowing potential man-in-the-middle attacks
...
- **Severity:** Moderate
- **Package:** System.Net.Security 4.0.0 (transitive)
- **Impact:** Additional TLS/SSL security issue (lower severity)
...
**1. [ ] Fix High Severity Vulnerabilities - Upgrade to .NET 8.0 LTS**
   ...
   - **Steps:**
     ...
     4. Run `dotnet build` to check for compilation issues
...
**10. [ ] Enable security alerts in repository**
   - Enable Dependabot security updates (GitHub)
...
**Automation:**
- Set up Dependabot or Renovate for automated pull requests
...
- Keep major versions up-to-date to avoid large migration efforts
...
- W3C Protocol - Only protocol supported
...
4. Full regression testing before merge
...
**Evaluation Duration:** ~90 seconds  
...
*Report saved: 2026-06-02 20:53:11*
